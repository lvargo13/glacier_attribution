function [ clim_f ] = get_cesm_force_grid( cesm_path,ind,lone,lonw,lats,latn,wantyr )
...
for i = 1:3
    ...
    for ii = 1:length(files)
      ...
      ta = mean2d(f_in(lone:lonw,lats:latn,:));
      temp_array = [temp_array; squeeze(ta)]; % full time (1920 - 2100)
      f_in = []; 
    end

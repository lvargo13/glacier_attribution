...
% input data:
gla = 'glenmary';  % glacier name
r1= 2000; % min and max SL range for plotting scatter plot  
r2 = 2400;
ann_thresh = 70; % threshold for annual RMSE for parameters used
mean_thresh = 6; % threshold for mean RMSE for parameters used
